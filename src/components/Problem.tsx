...
const statements: Statement[] = [
  ...
  },
  {
    ...
    desc: "In 1995, the kids who began with the internet led the next two decades. The kids who begin with AI now will lead the next — the window is open, and it starts at school.",
  },
];
