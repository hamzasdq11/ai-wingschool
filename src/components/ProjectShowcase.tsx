const projects = [
  ...
  },
  {
    ...
    description:
      "Fine-tuned a small model on classical Hindi, Urdu, Tamil, and Bengali verse. Her Demo Day talk was picked up by the Litfest blog.",
    ...
    <section id="projects" className="section-shell relative z-10">
      ...
      <div className="ui-card mt-12 flex flex-wrap items-center justify-between gap-6 rounded-[1.5rem] px-6 py-5 sm:px-8">
        <div>
          ...
          >
            Every cohort ends with a public Demo Day. Your child presents what
