...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes — and the second child gets 10% off, the third or more get 20% off. Discounts apply to Academy and AI Architect, are confirmed at signup, and don't require both children to be in the same season. The Trial Pass is already low-friction at ₹999, so we don't stack sibling discounts on top of it.",
  },
  {
  ...
  },
  {
    ...
    a: "Three ways. (1) Project deliverables every 3 weeks — actual working artefacts, not grades. (2) A parent progress report every 2 weeks on the Academy and AI Architect plans. (3) Flagship Expo Day at the end — you'll watch your child present what they built.",
  },
  {
