const plans = [
  {
    ...
    features: [
      ...
      "Continue to Builder by 22 May for Orientation Day",
    ],
    cta: "Start the Trial →",
    featured: false,
  },
  {
    ...
    description:
      "The full cohort experience. Six projects, weekly live sessions, hardware kits shipped home, Flagship Expo Day.",
    features: [
